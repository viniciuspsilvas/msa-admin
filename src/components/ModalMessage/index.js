...
export default function ModalMessage({ isOpen, toggle, to, callback }) {
    const { register, handleSubmit, errors, reset, control } = useForm();

    const [isToStudents, setIsToStudents] = useState(to !== 'Course')
    ...
    const onSubmit = async (data) => {
        ...
        await dispatch(sendNotification({ title, body, students, scheduledFor }));
